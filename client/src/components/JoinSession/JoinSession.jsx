            ...
            <div className="mainPart">
                <div className={`splits${isEditable ? 'Edit' : ''}`}>
                    <div className='mainInfo'>
                        ...
                        <Divider className='divider'/>
                        <h4 className='textMargin'>Members ({session.members.length} / {session.playersNeeded}):</h4>
                        <h4 className='textMargin'>{arrayToString(session.members)}</h4>
                        <Divider className='divider'/>
                        ...
                        <div className="equipmentInfo">
                            ...
                            <h4 className='textMargin'>{curSession.equipment}</h4>
                        </div>
                        {isEditable && (
